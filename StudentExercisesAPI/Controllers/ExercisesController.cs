...
namespace StudentExercisesAPI.Controllers
{
    ...
    public class ExercisesController : ControllerBase
    {
        ...
        // POST api/students
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] Exercise ex)
        {
            ...
            using (IDbConnection conn = Connection)
            {
                ...
                ex.Id = newId;
                return CreatedAtRoute("GetExercise", new { id = newId }, ex);
            }
        }

        // PUT api/students/5
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] Exercise ex)
        {
            string sql = $@"
            UPDATE Exercise
            SET Name = '{ex.Name}',
